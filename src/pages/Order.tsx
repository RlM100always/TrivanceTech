...
import { ClipboardCheck, Clock, HelpCircle, DollarSign, MessageCircle } from 'lucide-react';
          ...
          <div className="md:flex">
            <div className="md:w-1/3 bg-primary-700 text-white p-8">
              ...
              <div className="mt-12 pt-6 border-t border-white/20">
                ...
                <a
                  href={whatsappChatLink('Hi AiTechWorlds! I want to place a project order and have a few questions.')}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 mb-4 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg transition-colors"
                >
                ...
                <p className="text-sm text-primary-100">
                  Or email us at{' '}
                  <a href={`mailto:${CONTACT_EMAIL}`} className="text-white underline hover:text-primary-200">
                    {CONTACT_EMAIL}
                  </a>
                </p>
              </div>
            ...
            <div className="md:w-2/3 p-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <div className="text-center p-4">
                  ...
                  <h3 className="font-medium text-neutral-900 dark:text-white">Quality Work</h3>
                </div>
                <div className="text-center p-4">
                  <div className="w-12 h-12 bg-primary-100 dark:bg-primary-900/40 rounded-full flex items-center justify-center mx-auto mb-2">
                    <Clock size={24} className="text-primary-600 dark:text-primary-400" />
                  </div>
                  <h3 className="font-medium text-neutral-900 dark:text-white">On-Time Delivery</h3>
                </div>
                <div className="text-center p-4">
                  <div className="w-12 h-12 bg-primary-100 dark:bg-primary-900/40 rounded-full flex items-center justify-center mx-auto mb-2">
                    <HelpCircle size={24} className="text-primary-600 dark:text-primary-400" />
                  </div>
                  <h3 className="font-medium text-neutral-900 dark:text-white">24/7 Support</h3>
                </div>
                <div className="text-center p-4">
                  <div className="w-12 h-12 bg-primary-100 dark:bg-primary-900/40 rounded-full flex items-center justify-center mx-auto mb-2">
