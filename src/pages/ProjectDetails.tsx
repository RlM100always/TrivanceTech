...
import { ArrowLeft, Globe, Github, FileText, Star, User, Clock, Award, CheckCircle, ExternalLink, Code, Smartphone, PlayCircle, AlertCircle } from 'lucide-react';
                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6">
                  ...
                  {project.links.playStore && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
                    >
                  ...
                  {project.links.video && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center px-6 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
                    >
