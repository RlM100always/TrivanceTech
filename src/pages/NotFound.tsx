      ...
      <div className="text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button 
            ...
            className="px-6 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 font-medium rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center"
          >
